---
title: "Kaspert's AI assistant for financial insights"
sidebarTitle: "AI Assistant"
description: "Query transactions, get financial summaries, track payment obligations, and create ledger entries using Kaspert's MCP-based AI tools with natural language."
---
...
<Note>
  The AI assistant feature is accessible via the MCP endpoint at `/.lovable/mcp`. Contact **support@kaspert.be** for access credentials and setup instructions for your preferred AI client.
</Note>
...
All five MCP tools require an authenticated user session. The MCP server uses OAuth with your Kaspert (Supabase Auth) account as the identity provider. When you connect your AI client to the MCP endpoint, you will be prompted to log in with your Kaspert credentials — the tools then automatically operate on your active organisation's data.
